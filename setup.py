...
setup(
    ...
    version='1.7.1',
    description=("instagram-scraper is a command-line application written in Python that scrapes and downloads an instagram user\'s photos and videos. Use responsibly.  Forked from rarcega/instagram-scraper"),
    url='https://github.com/chmsant/instagram-scraper',
    download_url='https://github.com/chmsant/instagram-scraper/tarball/1.7.1',
